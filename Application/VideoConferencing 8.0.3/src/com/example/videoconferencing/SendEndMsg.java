...
public class SendEndMsg implements Runnable 
{
    ...
    public SendEndMsg(Context context)
    {
    	Log.d("test","in SendEndMsg constructor");
	...
	public void run() 
	{
		...
		try
		{
			...
			if(rdata.equalsIgnoreCase("free"))
				Log.d("test","send and received free msg");
		}
		catch(Exception e)
		{
